...
class menu_create:
    def __init__(self):
        ...
        if passtat in ['m','manual','b','2','02']:
            ...
            if password in ['1122334455','1234554321','112233445566','123456654321','091092093']:
...
class create_fb:
    ...
    def get_name(self):
        ...
        try:
            ...
            nam1 = random.choice(['osama','om','khalid','omar','علي','محمد'])
            nam2 = random.choice(['asia','ala','ali','ahmed','mohammed'])
            nam3 = random.choice(['ساسي','معاد','Qusay','Rahaf','Salem'])
